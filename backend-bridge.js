...
function renderFamilySync(error=''){
 ...
 let card=document.getElementById('familySyncCard');if(!card){card=document.createElement('div');card.id='familySyncCard';card.className='card family-sync';(document.getElementById('familySyncSlot')||parent).appendChild(card)}
